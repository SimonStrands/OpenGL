...
void Model::InstanceRender(GLuint Topology, uint32_t nrOfInstances)
{
     for(int i = 0; i < meshes.size(); i++){
        ...
        glDrawElementsInstanced(Topology, meshes[i].m_nrOfIndecies, GL_UNSIGNED_INT, nullptr, nrOfInstances);     
	}
}
